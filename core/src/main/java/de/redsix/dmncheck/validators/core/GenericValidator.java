 ...
 *
 * Note: We are using the Camunda implementation of the DMN model (https://github.com/camunda/camunda-dmn-model).
 *
 * To write a validation using this validator you have to specify:
 *
 *  1) The element type (T) that is validated
 *  2) The element type (S) that is used to check whether the validation is applicable
 *
