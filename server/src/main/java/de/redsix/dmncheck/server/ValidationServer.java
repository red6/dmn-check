...
public class ValidationServer {
    ...
    @Parameter(
        names = "-port",
        description = "Port the service should bind do."
    )
    ...
    public static void main(String[] args) {
        ...
        post("/validate", (request, response) -> {
            final ByteArrayInputStream dmnXmlStream = new ByteArrayInputStream(
            ...
            try {
                ...
                FieldUtils.writeField(
                    Dmn.INSTANCE,
                    "dmnParser",
                    new NonValidatingDmnParser(),
                    true
                );

                final DmnModelInstance modelInstance = Dmn.readModelFromStream(
                    dmnXmlStream
                );
                final List<ValidationResult> validationResults =
                    validationServer.runValidators(modelInstance);
                return validationServer
                    .validationResultsToJson(validationResults)
                    .toString();
    ...
    private DrgElement getDrgElementParent(
