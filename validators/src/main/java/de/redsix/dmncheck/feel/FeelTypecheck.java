...
public final class FeelTypecheck {
    ...
    public static Either<ValidationResult.Builder.ElementStep, ExpressionType> typecheck(
        ...
        return switch (expression) {
            ...
            case FeelExpression.RangeExpression(var __, var lowerBound, var upperBound, var ___) ->
            ...
            case FeelExpression.BinaryExpression(var left, var operator, var right) ->
                    typecheckBinaryExpression(context, left, operator, right);
            case FeelExpression.DisjunctionExpression(var head, var tail) ->
    ...
    private static Either<ValidationResult.Builder.ElementStep, ExpressionType> typecheckRangeExpression(
        ...
        final List<ExpressionType> allowedTypes = Arrays.asList(
                new ExpressionType.INTEGER(), new ExpressionType.DOUBLE(), new ExpressionType.LONG(), new ExpressionType.DATE());
