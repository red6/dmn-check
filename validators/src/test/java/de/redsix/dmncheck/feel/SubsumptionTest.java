...
class SubsumptionTest {
    ...
    void emptySubsumesEverything(final String input) {
        ...
        assertEquals(
            Optional.of(true),
            Subsumption.subsumes(emptyExpression, expression, Subsumption.eq)
        );
    }
    ...
    void nothingSubsumesEmptyExceptEmpty(final String input) {
        ...
        assertEquals(
            Optional.of(false),
            Subsumption.subsumes(expression, emptyExpression, Subsumption.eq)
        );
    }
    ...
    void nullSubsumesNull() {
        ...
        assertEquals(
            Optional.of(true),
            Subsumption.subsumes(nullExpression, nullExpression, Subsumption.eq)
        );
    }
    ...
    void rangeExpressionsThatSubsumeEachOther(
        final String subsumingInput,
        final String subsumedInput
    ) {
    ...
    void rangeExpressionsThatDoNotSubsumeEachOther(
        final String subsumingInput,
        final String subsumedInput
    ) {
    ...
    void comparisonExpressionsThatSubsumesRangeExpression(
        final String subsumingInput,
        final String subsumedInput
    ) {
        assertLeftIsSubsumedByRight(subsumingInput, subsumedInput);
    ...
    void subsumptionForBooleanIsEqualityPositiveCases(
        final String subsumingInput,
        final String subsumedInput
    ) {
        assertLeftIsSubsumedByRight(subsumingInput, subsumedInput);
    ...
    void subsumptionForNotPositveCases(
        final String subsumingInput,
        final String subsumedInput
    ) {
        assertLeftIsSubsumedByRight(subsumingInput, subsumedInput);
    ...
    void subsumptionForBooleanIsEqualityNegativeCases(
        final String subsumingInput,
        final String subsumedInput
    ) {
        assertLeftIsNotSubsumedByRight(subsumingInput, subsumedInput);
    ...
    void subsumptionForNotNegativeCases(
        final String subsumingInput,
        final String subsumedInput
    ) {
        assertLeftIsNotSubsumedByRight(subsumingInput, subsumedInput);
    ...
    void subsumptionRangeExpressionsAndLiteralsPositiveCases(
        final String subsumingInput,
        final String subsumedInput
    ) {
        assertLeftIsSubsumedByRight(subsumingInput, subsumedInput);
    ...
    void subsumptionRangeExpressionsAndLiteralsNegativeCases(
        final String subsumingInput,
        final String subsumedInput
    ) {
        assertLeftIsNotSubsumedByRight(subsumingInput, subsumedInput);
    ...
    private static void assertLeftIsSubsumedByRight(
    ...
    private static void assertLeftIsNotSubsumedByRight(
        String subsumingInput,
        String subsumedInput
    ) {
        final FeelExpression subsumingExpression = FeelParser.PARSER.parse(
