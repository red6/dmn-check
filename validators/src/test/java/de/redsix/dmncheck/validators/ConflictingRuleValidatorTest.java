...
class ConflictingRuleValidatorTest extends WithDecisionTable {
    ...
    private final ConflictingRuleValidator testee =
        new ConflictingRuleValidator();
    ...
    void shouldDetectConflictingRulesForGivenHitPolicies(
        ...
        assertAll(
            () ->
                assertEquals(
                    "Rule is conflicting with rules [" + rule2.getId() + "]",
