...
class InputEntryTypeValidatorTest extends WithDecisionTable {
    ...
    private final InputEntryTypeValidator testee =
        new InputEntryTypeValidator();
    ...
    void shouldAcceptValidEnumValues() {
        ...
        ProjectClassLoader.INSTANCE.classLoader =
    ...
    void shouldRejectIllTypedInputExpression() {
        ...
        assertAll(
            () ->
                assertEquals(
                    "Type of input entry does not match type of input expression",
                    validationResult.getMessage()
                ),
            () -> assertEquals(rule, validationResult.getElement()),
            () -> assertEquals(Severity.ERROR, validationResult.getSeverity())
